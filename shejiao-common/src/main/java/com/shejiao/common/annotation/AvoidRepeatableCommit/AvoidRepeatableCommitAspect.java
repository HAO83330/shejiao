package com.shejiao.common.annotation.AvoidRepeatableCommit;
...
public class AvoidRepeatableCommitAspect {
     ...
     * @param point
     */
    @Around("@annotation(com.shejiao.common.annotation.AvoidRepeatableCommit.AvoidRepeatableCommit)")
