...
public class WebFollowController {
     ...
     * @param type        类型
     */
    @GetMapping("getFriend/{currentPage}/{pageSize}/{uid}/{type}")
    public Result<?> getFriend(@PathVariable long currentPage, @PathVariable long pageSize, @PathVariable String uid, @PathVariable Integer type) {
