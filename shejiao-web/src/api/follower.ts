 ...
 * @returns 
 */
export const getFollowList = (currentPage: number, pageSize: number, uid: string) => {
  return request<any>({
    url: `/web/follower/getFriend/${currentPage}/${pageSize}/${uid}/1`, // mock接口
    method: "get",
  });
};
 ...
 * @returns 
 */
export const getFanList = (currentPage: number, pageSize: number, uid: string) => {
  return request<any>({
    url: `/web/follower/getFriend/${currentPage}/${pageSize}/${uid}/0`, // mock接口
    method: "get",
  });
};
