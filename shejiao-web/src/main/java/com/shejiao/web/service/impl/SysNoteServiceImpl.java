...
import com.shejiao.common.utils.*;
...
import com.shejiao.web.mapper.SysNavbarMapper;
import com.shejiao.web.mapper.SysNoteMapper;
...
public class SysNoteServiceImpl implements ISysNoteService {
    ...
    @Autowired
    private com.shejiao.web.websocket.im.ChatUtils chatUtils;
    @Autowired
    private com.shejiao.web.service.IWebMentionService mentionService;
    ...
    @Override
    public List<WebNote> selectNoteByIds(List<Long> ids) {
        return noteMapper.selectBatchIds(ids);
    }
...
//        }
     ...
     */
    @Override
    public boolean auditNote(String noteId, String auditType, String rejectReason) {
...
//                    .setTags(tags.toString())
            ...
            // 审核通过后发送@提及通知
            java.util.List<com.shejiao.web.domain.entity.WebMention> mentionList = mentionService.list(new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<com.shejiao.web.domain.entity.WebMention>().eq("nid", noteId));
            for (com.shejiao.web.domain.entity.WebMention mention : mentionList) {
                chatUtils.sendMessage(mention.getUid(), 1);
            }
        }
        // 拒绝：2
