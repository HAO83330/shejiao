package com.shejiao.web.websocket;

import com.shejiao.web.websocket.config.ServerEncoder;
...
public class WebSocketServer {
    ...
    public void onOpen(Session session, @PathParam(value = "uid") String uid) {
        // 检查用户是否已经存在连接，如果不存在才增加在线人数
        if (!SESSION_POOLS.containsKey(uid)) {
            addOnlineCount();
        }
