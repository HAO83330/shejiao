      ...
      <div class="parent-comment" v-for="(oneComment, oneIndex) in dataList" :key="oneIndex">
        <div class="comment-item">
          <div class="comment-inner-container">
            <div class="avatar">
              <img class="avatar-item" :src="oneComment.avatar" @click="toUser(oneComment.uid)" />
            </div>
            <div class="right">
              ...
              <div class="info">
                ...
                <div class="interactions">
                  <div class="like">
                    <span
                      class="like-wrapper"
                      @click="likeComment(oneComment, oneComment.isLike ? -1 : 1, oneIndex, -1)"
                    >
                      <i
        ...
        <div class="reply-container">
          <div class="list-container">
            <div class="comment-item" v-for="(twoComment, twoIndex) in oneComment.children" :key="twoIndex">
              <div class="comment-inner-container">
                <div class="avatar">
                  <img class="avatar-item" :src="twoComment.avatar" @click="toUser(twoComment.uid)" />
                </div>
                <div class="right">
                  <div class="author-wrapper">
                    <div class="author">
